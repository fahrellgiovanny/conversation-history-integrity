"""verify_stack.orchestrator - session orchestrator wrapping the T1 tier (Integrity Framework).
...
- emits one session row per turn with the unified integrity CSV schema
