"""integritylib - shared library for the Integrity Framework (EXP-1..EXP-7) runners.

Frozen plan numbers per pre_registration.md (rev. 4, 2026-08-07) and
SIMULATION_PAPER3.md (rev. 4). Do not edit cell counts here without an
...
# EXP-8 (amendment 2026-08-09): instruction-override family M8.
EXP8 = {
...
# integritylib.api.call_with_retry (GLM semaphore) + config.WORKERS.
GLM_MAX_CONCURRENCY = 5
MAX_OUTPUT_TOKENS = 4096
TEMPERATURE = 0.0

OUTPUT_DIR = SCRIPT_DIR / "output" / "integrity"
...
EXP1 = {
    # 1a/1b run on Gemini AND GPT (three-model determinism audit, rev. 5):
...
EXP6 = {
    "conditions": ["salami", "farma"],  # MemCollusion salami; FARMA forged reasoning
    "n": 20,
}
...
EXP7 = {
    ...
    "memsecbench_modes": 7,
    "memsecbench_per_mode": 5,
    "memsecbench_conditions": ["control", "M1", "M3"],
