...
conversation-history integrity manifest (benchmarks/agentdojo_scenarios.json).
...
def main() -> None:
    ...
    manifest = {
        ...
        "rendering_note": "Official texts verbatim; delivery rendered into the conversation-history integrity "
