#!/usr/bin/env python3
"""build_lifecycle_cases - self-constructed lifecycle cases following the
...
OUT = Path(__file__).resolve().parent / "lifecycle_cases.json"
...
def main() -> None:
    ...
    manifest = {
        "source": "SELF-CONSTRUCTED (NOT the official benchmark). Follows the "
                  ...
                  "per the pre-registered protocol rev. 4 contingency. Each mode has 5 cases "
