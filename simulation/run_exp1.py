#!/usr/bin/env python3
"""run_exp1 - EXP-1: L1 scale evaluation (SIMULATION_PAPER3 rev. 4).
...
Workers default 10; batches checkpoint to output/integrity/exp1_*.csv.
"""
...
from integritylib.report import print_detection, print_fp  # noqa: E402
...
from integritylib.session import SessionRunner  # noqa: E402
...
def run_one(model, task: dict, dry: bool) -> list:
    ...
    if task["cell"] == "1c_neutral":
        # B (rev. 2026-08-09): defended sessions with a PREMISE-NEUTRAL
...
def run_adaptive(model, case, task: dict, dry: bool) -> list:
    ...
    """
    from integritylib.session import baseline_prompt, clean_prompt, make_row, serialize_log
