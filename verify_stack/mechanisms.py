"""verify_stack.mechanisms - EXP-5 pluggable mechanism classes (conversation-history integrity).

Unified public interface (identical for all mechanisms, per the pre-registered protocol):
...
# ---------------------------------------------------------------------------
# M8 - instruction-override family (EXP-8, literature-grounded)
# ---------------------------------------------------------------------------
